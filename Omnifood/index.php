...
<html lang="en">
    <head>
        ...
        <meta name="description" content="Omnifood is a premiumm food delivery service with the mission to bring affordable and healty meals to as many people as possible.">
    ...
    <body>
        <header>
            ...
            <div class="hero-text-box">
                ...
                <a class="btn btn-gost js--scroll-to-start" href="#">Show me more</a>
            </div>
        </header>
                    ...
                    <div class="plan-box">
                        ...
                        <div>
                            <ul>
                                ...
                                <li><ion-icon name="close-outline" class="icon-small"></ion-icon>Newest creations</li>
                                <li><ion-icon name="checkmark-outline" class="icon-small"></ion-icon>Free delivery</li>
                            </ul>
                        </div>
                        <div>
                    ...
                    <form method="post" action="mailer.php" class="contact-form">
                        <div class="row">
                            ...
                            if($_GET['success'] == -1){
                                ...
                                Oos! Something went wrong. Please try again!
                                </div>";
                            }
                            ?>
                        </div>
            ...
            <div class="row">
                ...
                <div class="col span-1-of-2">
                    <ul class="social-links">
                        ...
                        <li><a href="#"><ion-icon name="logo-google" class="logo-google"></ion-icon></a></li>
